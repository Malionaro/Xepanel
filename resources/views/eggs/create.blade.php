...
@section('header_title', __('panel.egg_templates_create'))
                ...
                <div class="flex-1 space-y-8">
                    <div class="space-y-3">
                        ...
                        <div class="flex gap-6">
                            ...
                            <input type="text" name="name" class="flex-1 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-[1.5rem] py-4 px-8 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all dark:text-white font-black text-2xl shadow-sm" required placeholder="{{ __('panel.egg_name_placeholder') }}">
                        </div>
                    </div>
                    <div class="space-y-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="glass dark:bg-dark-card border border-slate-200 dark:border-white/5 p-10 rounded-[3.5rem] shadow-xl">
                ...
                <div id="docker-config" class="hidden space-y-8">
                    ...
                    <div class="space-y-3">
                        <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">{{ __('panel.runtime_override') }}</label>
